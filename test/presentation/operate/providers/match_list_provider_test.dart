...
void main() {
  ...
  group('MatchListProvider Tests', () {
    test('matchStreamProvider should return matches from local repository', () async {
      final container = createContainer();
      
      final mockMatches = [
        const MatchModel(id: '1', tournamentId: 't1', redName: '赤', whiteName: '白', matchType: '団体戦', status: 'ready', order: 1.0)
      ];
