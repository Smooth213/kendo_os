...
void main() async {
  ...
  final tests = [
    'dart run tools/governance/lint.dart',
    'dart run tools/governance/semantic_drift_detector.dart',
    'dart run tools/governance/package_verifier.dart',
    'flutter test test/chaos/drift_attack_test.dart',
    'flutter test packages/replay_engine/test/phase0_event_replay_snapshot_test.dart',
  ];
