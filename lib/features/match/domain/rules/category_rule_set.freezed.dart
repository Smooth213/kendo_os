...
mixin _$CategoryRuleSet {
 ...
 String get subtitle; String get comment; MatchRule get normalRule; MatchRule get advancedRule; bool get useAdvancedRule; List<String> get advancedKeywords; String get matchType; bool get isMultiScene; bool get useHonsenRule; bool get useRenseikaiRule; bool get useMoushiawaseRule; MatchRule get renseikaiRule; MatchRule get moushiawaseRule;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,subtitle,comment,normalRule,advancedRule,useAdvancedRule,const DeepCollectionEquality().hash(advancedKeywords),matchType,isMultiScene,useHonsenRule,useRenseikaiRule,useMoushiawaseRule,renseikaiRule,moushiawaseRule);

@override
String toString() {
  return 'CategoryRuleSet(subtitle: $subtitle, comment: $comment, normalRule: $normalRule, advancedRule: $advancedRule, useAdvancedRule: $useAdvancedRule, advancedKeywords: $advancedKeywords, matchType: $matchType, isMultiScene: $isMultiScene, useHonsenRule: $useHonsenRule, useRenseikaiRule: $useRenseikaiRule, useMoushiawaseRule: $useMoushiawaseRule, renseikaiRule: $renseikaiRule, moushiawaseRule: $moushiawaseRule)';
}
...
@useResult
$Res call({
 String subtitle, String comment, MatchRule normalRule, MatchRule advancedRule, bool useAdvancedRule, List<String> advancedKeywords, String matchType, bool isMultiScene, bool useHonsenRule, bool useRenseikaiRule, bool useMoushiawaseRule, MatchRule renseikaiRule, MatchRule moushiawaseRule
});
...
/// Create a copy of CategoryRuleSet
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? subtitle = null,Object? comment = null,Object? normalRule = null,Object? advancedRule = null,Object? useAdvancedRule = null,Object? advancedKeywords = null,Object? matchType = null,Object? isMultiScene = null,Object? useHonsenRule = null,Object? useRenseikaiRule = null,Object? useMoushiawaseRule = null,Object? renseikaiRule = null,Object? moushiawaseRule = null,}) {
...
as String,normalRule: null == normalRule ? _self.normalRule : normalRule // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String subtitle,  String comment,  MatchRule normalRule,  MatchRule advancedRule,  bool useAdvancedRule,  List<String> advancedKeywords,  String matchType,  bool isMultiScene,  bool useHonsenRule,  bool useRenseikaiRule,  bool useMoushiawaseRule,  MatchRule renseikaiRule,  MatchRule moushiawaseRule)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryRuleSet() when $default != null:
return $default(_that.subtitle,_that.comment,_that.normalRule,_that.advancedRule,_that.useAdvancedRule,_that.advancedKeywords,_that.matchType,_that.isMultiScene,_that.useHonsenRule,_that.useRenseikaiRule,_that.useMoushiawaseRule,_that.renseikaiRule,_that.moushiawaseRule);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String subtitle,  String comment,  MatchRule normalRule,  MatchRule advancedRule,  bool useAdvancedRule,  List<String> advancedKeywords,  String matchType,  bool isMultiScene,  bool useHonsenRule,  bool useRenseikaiRule,  bool useMoushiawaseRule,  MatchRule renseikaiRule,  MatchRule moushiawaseRule)  $default,) {final _that = this;
switch (_that) {
case _CategoryRuleSet():
return $default(_that.subtitle,_that.comment,_that.normalRule,_that.advancedRule,_that.useAdvancedRule,_that.advancedKeywords,_that.matchType,_that.isMultiScene,_that.useHonsenRule,_that.useRenseikaiRule,_that.useMoushiawaseRule,_that.renseikaiRule,_that.moushiawaseRule);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String subtitle,  String comment,  MatchRule normalRule,  MatchRule advancedRule,  bool useAdvancedRule,  List<String> advancedKeywords,  String matchType,  bool isMultiScene,  bool useHonsenRule,  bool useRenseikaiRule,  bool useMoushiawaseRule,  MatchRule renseikaiRule,  MatchRule moushiawaseRule)?  $default,) {final _that = this;
switch (_that) {
case _CategoryRuleSet() when $default != null:
return $default(_that.subtitle,_that.comment,_that.normalRule,_that.advancedRule,_that.useAdvancedRule,_that.advancedKeywords,_that.matchType,_that.isMultiScene,_that.useHonsenRule,_that.useRenseikaiRule,_that.useMoushiawaseRule,_that.renseikaiRule,_that.moushiawaseRule);case _:
  return null;
...
class _CategoryRuleSet implements CategoryRuleSet {
  const _CategoryRuleSet({this.subtitle = '', this.comment = '', this.normalRule = const MatchRule(), this.advancedRule = const MatchRule(), this.useAdvancedRule = false, final  List<String> advancedKeywords = const ['準決勝', '準決', '決勝', 'final', '3位決定', '3決', 'ベスト4'], this.matchType = '個人戦', this.isMultiScene = false, this.useHonsenRule = true, this.useRenseikaiRule = true, this.useMoushiawaseRule = true, this.renseikaiRule = const MatchRule(matchTimeMinutes: 2, isRunningTime: true, hasHantei: true, enchoCount: 0, isEnchoUnlimited: false, isRenseikai: true, matchScene: 'renseikai'), this.moushiawaseRule = const MatchRule(matchTimeMinutes: 2, isRunningTime: true, hasHantei: true, enchoCount: 0, isEnchoUnlimited: false, isRenseikai: true, matchScene: 'moushiawase')}): _advancedKeywords = advancedKeywords;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,subtitle,comment,normalRule,advancedRule,useAdvancedRule,const DeepCollectionEquality().hash(_advancedKeywords),matchType,isMultiScene,useHonsenRule,useRenseikaiRule,useMoushiawaseRule,renseikaiRule,moushiawaseRule);
...
/// Create a copy of CategoryRuleSet
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? subtitle = null,Object? comment = null,Object? normalRule = null,Object? advancedRule = null,Object? useAdvancedRule = null,Object? advancedKeywords = null,Object? matchType = null,Object? isMultiScene = null,Object? useHonsenRule = null,Object? useRenseikaiRule = null,Object? useMoushiawaseRule = null,Object? renseikaiRule = null,Object? moushiawaseRule = null,}) {
