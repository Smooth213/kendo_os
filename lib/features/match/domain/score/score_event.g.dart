...
Map<String, dynamic> _$ScoreEventToJson(_ScoreEvent instance) =>
    <String, dynamic>{
      ...
      'isRetirement': instance.isRetirement,
      'isHantei': instance.isHantei,
      'isUndo': instance.isUndo,
