...
import 'components/match_screen/match_bottom_action_section.dart'; // ★ Phase 5: 戦略ファクトリの読み込み
                            ...
                            child: GestureDetector(
                              ...
                              child: LayoutBuilder(
                                builder: (context, constraints) {
                                  ...
                                  final bottomButtonPart =
                                      MatchBottomActionSection(
                                        match: match,
                                        rule: rule,
                                        isApproved: isApproved,
                                        isViewOnly: isViewOnly,
                                        ...
                                        onShowConfirmDialog: _showConfirmDialog,
                                        onShowMatchFinishedDialog:
                                            _showMatchFinishedDialog,
                                        onShowHanteiDialog: _showHanteiDialog,
                                      );
