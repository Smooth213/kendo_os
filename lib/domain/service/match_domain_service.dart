...
class MatchDomainService {
  ...
  List<ScoreEvent> _createDoubleFusen(Side side, String? scorerId) {
    return [
      ScoreEvent(id: const Uuid().v4(), side: side, type: PointType.fusen, timestamp: DateTime.now(), userId: scorerId, sequence: 1),
      ScoreEvent(id: const Uuid().v4(), side: side, type: PointType.fusen, timestamp: DateTime.now(), userId: scorerId, sequence: 2),
    ];
  }
