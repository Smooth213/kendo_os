...
mixin _$MatchModel implements DiagnosticableTreeMixin {
 ...
 String get organizationId; String get matchType; String get redName; String get whiteName; int get redScore; int get whiteScore; String get status; List<ScoreEvent> get events; List<MatchSnapshot> get snapshots;// ★ Phase 4: isDirtyを廃止し、厳密なSyncStateと差分キュー(pendingEvents)を導入
...
@override@JsonKey() List<ScoreEvent> get pendingEvents {
