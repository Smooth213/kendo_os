...
import 'package:kendo_os/domain/entities/timeline_item.dart';   // ★ 追加: タイムライン統合インターフェース
...
abstract class MatchModel with _$MatchModel implements TimelineItem {
  ...
  @Assert('accumulatedPauseDurationMs >= 0', 'Accumulated pause duration cannot be negative')
