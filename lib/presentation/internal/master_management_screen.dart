...
class _MasterManagementScreenState extends ConsumerState<MasterManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool canManageMaster = FeatureGate.canManageMaster(currentRole, currentLevel);
                        ...
                        Container(
                          ...
                          child: Column(
                            children: groupItems.asMap().entries.map((entry) {
                              ...
                              return Column(
                                children: [
                                  _buildPlayerTile(context, ref, player, isReadOnly, canManageMaster),
                                  if (!isLast)
  ...
  Widget _buildPlayerTile(BuildContext context, WidgetRef ref, PlayerModel player, bool isReadOnly, bool canManageMaster) {
    final isDark = Theme.of(context).brightness == Brightness.dark; 
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            if (FeatureGate.canManageMaster(ref.read(currentUserRoleProvider), ref.read(securityLevelProvider)))
              ListTile(
                contentPadding: EdgeInsets.zero,
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) => Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: FeatureGate.canManageMaster(ref.watch(currentUserRoleProvider), ref.watch(securityLevelProvider))
                            ? IconButton(
