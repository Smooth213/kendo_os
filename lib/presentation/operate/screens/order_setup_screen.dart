      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          AnimatedSize(
            ...
            child: isKeyboardOpen ? const SizedBox.shrink() : _buildStaticHeader(),
          ),
          Expanded(
          ...
          AnimatedSize(
            duration: const Duration(milliseconds: 250),
            curve: Curves.easeInOut,
            child: isKeyboardOpen ? const SizedBox.shrink() : Container(
              padding: EdgeInsets.only(left: 24, right: 24, top: 24, bottom: MediaQuery.of(context).padding.bottom + 24),
              decoration: BoxDecoration(color: enableLiquidGlass ? Colors.transparent : inputBgColor, border: Border(top: BorderSide(color: enableLiquidGlass ? Colors.transparent : borderColor, width: 0.5))),
              child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    TextButton.icon(
