...
class RoleSelectScreen extends StatelessWidget {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildRoleRow(context, '最高管理者 (Admin)', UserRole.admin, Colors.purple),
                          const SizedBox(height: 16),
                          _buildRoleRow(context, '大会運営者 (Operator)', UserRole.operator, Colors.teal),
                          const SizedBox(height: 16),
                          _buildRoleRow(context, '試合記録者 (Recorder)', UserRole.recorder, Colors.indigo),
                          const SizedBox(height: 16),
                          _buildRoleRow(context, '一般観客席 (Viewer) [PIN不要]', UserRole.viewer, Colors.blueGrey),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget _buildRoleRow(BuildContext context, String title, UserRole role, Color color) {
    return SizedBox(
