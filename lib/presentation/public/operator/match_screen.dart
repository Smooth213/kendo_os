                  ...
                  child: GestureDetector(
                    ...
                    onHorizontalDragEnd: (details) {
                      if (details.primaryVelocity != null &&
                        ...
                        if (match.events.any(
                          (e) => !e.isCanceled && e.type != PointType.undo,
                        )) {
                      ...
                      builder: (context, constraints) {
                        ...
                        final undoArea = Column(
                          children: [
                            ...
                            Container(
                              height:
                                  62, // ★ 3件表示時の5pxのはみ出し（RenderFlex overflow）を完全に解消
                              ...
                              alignment:
                                  Alignment.bottomCenter, // 下から積み上がるように配置
                        ...
                        final scoreboardPart = ConstrainedBox(
                          constraints: BoxConstraints(
                            maxHeight:
                                ...
                                0.32, // ★ スコアボードの最大高さをさらに拡張し、選手名をさらに大きく表示
                          ),
                          child: FittedBox(
                              ...
                              child: ProviderScope(
                                overrides: [
                                  ...
                                  scoreboardNameTapProvider.overrideWithValue(
                                    (side) =>
                                        _showNameEditBottomSheet(match, side),
                                  ),
                                ],
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              if (rule.isRenseikai &&
                                  ...
                                  (match.matchType == rule.positions.last ||
                                      match.matchType == '錬成会') &&
                                  match.status == 'finished') {
                              ...
                              if (match.status == 'finished') {
                                ...
                                return GestureDetector(
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed:
                                        settings.confirmBehavior == 'single'
                                        ? confirmAction
                                        : (isViewOnly
                                              ? null
                                              : () =>
                                ...
                                final finishAction = isViewOnly
                                    ...
                                    : () async {
                                        ...
                                        if (match.isKachinuki &&
                                          ...
                                          if ((match.redScore as num).toInt() >
                                              (match.whiteScore as num)
                                                  .toInt()) {
                                            winnerColor = 'red';
                                          } else if ((match.whiteScore as num)
                                                  .toInt() >
                                        ...
                                        if (match.redScore ==
                                          ...
                                          if (nextAction ==
                                              NextMatchAction.startExtension) {
                                            final confirmed =
                                                await _showConfirmDialog(
                                                  '延長戦',
                                                  '延長戦に入りますか？',
                                ...
                                return Consumer(
                                  builder: (context, ref, child) {
                                    ...
                                    final effectiveFinishAction = isProcessing
                                        ? null
                                        : finishAction;
