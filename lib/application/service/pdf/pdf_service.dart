...
import 'painters/pdf_kachinuki_painter.dart';
import 'widgets/pdf_league_table.dart';
import 'widgets/pdf_individual_list.dart';
import 'widgets/pdf_team_table.dart';
          ...
          for (int i = 0; i < groupDataList.length; i++) {
            ...
            if (isKachinuki) {
              ...
              if (normalMatches.isNotEmpty) {
                ...
                final matchups = PdfViewModel.groupByMatchup(normalMatches);
              ...
              if (tieBreakMatches.isNotEmpty) {
                ...
                if (isIndivTie) {
                  ...
                  final tieMatchups = PdfViewModel.groupByMatchup(tieBreakMatches);
