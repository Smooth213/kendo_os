...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,matchType,redName,whiteName,redScore,whiteScore,status,const DeepCollectionEquality().hash(events),isDirty,lastUpdatedAt,const DeepCollectionEquality().hash(refereeNames),countForStandings,scorerId,version,isAutoAssigned,order,source,tournamentId,category,groupName,matchOrder,matchTimeMinutes,isRunningTime,hasExtension,extensionTimeMinutes,extensionCount,hasHantei,remainingSeconds,timerIsRunning,note,isKachinuki,const DeepCollectionEquality().hash(redRemaining),const DeepCollectionEquality().hash(whiteRemaining)]);

@override
String toString() {
  return 'MatchModel(id: $id, matchType: $matchType, redName: $redName, whiteName: $whiteName, redScore: $redScore, whiteScore: $whiteScore, status: $status, events: $events, isDirty: $isDirty, lastUpdatedAt: $lastUpdatedAt, refereeNames: $refereeNames, countForStandings: $countForStandings, scorerId: $scorerId, version: $version, isAutoAssigned: $isAutoAssigned, order: $order, source: $source, tournamentId: $tournamentId, category: $category, groupName: $groupName, matchOrder: $matchOrder, matchTimeMinutes: $matchTimeMinutes, isRunningTime: $isRunningTime, hasExtension: $hasExtension, extensionTimeMinutes: $extensionTimeMinutes, extensionCount: $extensionCount, hasHantei: $hasHantei, remainingSeconds: $remainingSeconds, timerIsRunning: $timerIsRunning, note: $note, isKachinuki: $isKachinuki, redRemaining: $redRemaining, whiteRemaining: $whiteRemaining)';
}
...
@useResult
$Res call({
 String id, String matchType, String redName, String whiteName, int redScore, int whiteScore, String status, List<ScoreEvent> events, bool isDirty,@TimestampConverter() DateTime? lastUpdatedAt, List<String> refereeNames, bool countForStandings, String? scorerId, int version, bool isAutoAssigned,@DoubleConverter() double order, String source, String? tournamentId, String? category, String? groupName, int? matchOrder, int matchTimeMinutes, bool isRunningTime, bool hasExtension, int? extensionTimeMinutes, int? extensionCount, bool hasHantei, int remainingSeconds, bool timerIsRunning, String note, bool isKachinuki, List<String> redRemaining, List<String> whiteRemaining
});
...
as List<ScoreEvent>,isDirty: null == isDirty ? _self.isDirty : isDirty // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of MatchModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? matchType = null,Object? redName = null,Object? whiteName = null,Object? redScore = null,Object? whiteScore = null,Object? status = null,Object? events = null,Object? isDirty = null,Object? lastUpdatedAt = freezed,Object? refereeNames = null,Object? countForStandings = null,Object? scorerId = freezed,Object? version = null,Object? isAutoAssigned = null,Object? order = null,Object? source = null,Object? tournamentId = freezed,Object? category = freezed,Object? groupName = freezed,Object? matchOrder = freezed,Object? matchTimeMinutes = null,Object? isRunningTime = null,Object? hasExtension = null,Object? extensionTimeMinutes = freezed,Object? extensionCount = freezed,Object? hasHantei = null,Object? remainingSeconds = null,Object? timerIsRunning = null,Object? note = null,Object? isKachinuki = null,Object? redRemaining = null,Object? whiteRemaining = null,}) {
