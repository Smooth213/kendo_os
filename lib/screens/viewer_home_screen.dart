                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            if (!label.contains('リーグ戦') && firstMatch.groupName != null) ...[
                                                              const SizedBox(width: 8),
                                                              SizedBox(
                                                                height: 28,
                                                                  ...
                                                                  subtitle: Padding(
                                                                    ...
                                                                    child: Wrap(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (bouts.isNotEmpty && bouts.first.groupName != null)
                                                                          SizedBox(
                                                                            height: 24,
                                                                            child: OutlinedButton(
                                                                              onPressed: () {
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            ...
            if ((isIndividual || match.note.contains('[順位決定戦]') || match.matchType == '代表戦') && match.groupName != null)
              SizedBox(
                height: 28,
                child: OutlinedButton(
                  onPressed: () {
